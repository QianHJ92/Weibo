...
//创建数据库之类的
$db=@mysqli_connect('localhost', 'root', 'admin@ADMIN') or @mysqli_connect('localhost', 'root', 'admin@ADMIN');
//print_r($db);
// 检测连接
//if (!$db) {
...
mysqli_query($db,'CREATE DATABASE qq_ajax');

mysqli_select_db($db,'qq_ajax');

$sql= <<< END
CREATE TABLE  `qq_ajax`.`weibo` (
